"""
Django settings for letitsell project.
...
SECRET_KEY = 'e8v7^@j-mok44_tyus4xju@qpn)to816!^(16@&!d7#^4c^f5!'
...
WSGI_APPLICATION = 'letitsell.wsgi.application'
