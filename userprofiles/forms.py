...
class RegistrationForm(forms.Form):
    username = forms.RegexField(label="Username", max_length=30,
                                regex=r'^[\w.-]+$', error_messages={'invalid': 'This value may contain only letters,'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update({'placeholder': 'Your e-mail'})

        self.fields['password'].widget.attrs.update({'class': 'form-control'})
        self.fields['password'].widget.attrs.update({'placeholder': 'Think twice'})
